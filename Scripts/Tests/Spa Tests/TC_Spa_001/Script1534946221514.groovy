...
WebUI.verifyElementPresent(findTestObject('Pages/Dashboard/a_SPA Management'), 5)

WebUI.verifyElementVisible(findTestObject('Pages/Dashboard/a_SPA Management'))
