...
WebUI.verifyElementPresent(findTestObject('Pages/Restaurant Page/btn_publish'), 0)

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/btn_publish'))
