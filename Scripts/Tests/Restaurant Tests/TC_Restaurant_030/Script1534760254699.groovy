...
WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Push Update/dropdown_By_default'))

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Push Update/dropdown_Which_default'))

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Push Update/input_select_options_default'))
