...
WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Add Restaurant/form_add_restaurant'))

WebUI.click(findTestObject('Pages/Restaurant Page/Add Restaurant/btn_dimiss_modal'))

WebUI.waitForElementNotVisible(findTestObject('Pages/Restaurant Page/Add Restaurant/form_add_restaurant'), 5)

WebUI.verifyElementNotVisible(findTestObject('Pages/Restaurant Page/Add Restaurant/form_add_restaurant'))
