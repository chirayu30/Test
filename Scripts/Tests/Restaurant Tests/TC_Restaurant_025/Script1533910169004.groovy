...
WebUI.click(findTestObject('Pages/Restaurant Page/btn_search'))

WebUI.setText(findTestObject('Pages/Restaurant Page/btn_search'), 'Dummy')

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/test5_res_cell'))
