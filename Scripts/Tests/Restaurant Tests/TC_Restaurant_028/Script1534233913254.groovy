...
WebUI.verifyElementPresent(findTestObject('Pages/Restaurant Page/Push Update/label_Schedule_date'), 10)

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Push Update/label_Schedule_date'))

WebUI.verifyElementPresent(findTestObject('Pages/Restaurant Page/Push Update/label_Schedule_time'), 10)

WebUI.verifyElementVisible(findTestObject('Pages/Restaurant Page/Push Update/label_Schedule_time'))
